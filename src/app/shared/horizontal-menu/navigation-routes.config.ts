...
export const HROUTES: RouteInfo[] = [
  ...
  // },
  {
    path: '/sales-kpi-dashboard', title: 'Sales KPIs Dashboard', icon: 'ft-pie-chart', class: 'nav-item', isExternalLink: false,
    submenu: []
  },
  {
    path: '/tenderwise-details', title: 'Tender wise details', icon: 'ft-trending-up', class: '', isExternalLink: false,
    submenu: []
  },
  {
    path: '/periodic-dashboard', title: 'Periodic Dashboard', icon: 'ft-bar-chart-2', class: '', isExternalLink: false,
    submenu: []
  },
  // {
